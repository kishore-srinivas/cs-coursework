...
public class Circle extends Shape2D {
	...
	/**
	 * Creates a new instance of a Circle object with specified stroke and fill color and stroke weight
	 * 
	 ...
	 * 
	 * @param x1 The x coordinate of given point
	 * @param y1 The y coordinate of given point
	 ...
	 * @param x1 The x coordinate of given point
	 * @param y1 The y coordinate of given point
	 * @param marker The PApplet used to draw the ellipse
	 */
	public void mirrorPoint(double x1, double y1, PApplet marker) {
		marker.ellipse((float)this.x, (float)this.y, (float)(Math.abs(x1 - this.x) + r), (float)(Math.abs(y1 - this.y) + r));
	}
	
	/**
	 * Determines whether the current circle intersects another
	 * 
	 * @param other Circle to check intersection with
