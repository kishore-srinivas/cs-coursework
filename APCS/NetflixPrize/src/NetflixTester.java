...
public class NetflixTester {
	...
	public static final String baseFile = "test-dataset" + FileIO.DELIMITER + "5Ratings.csv";
	public static final String testFile = "test-dataset" + FileIO.DELIMITER + "5Tests.csv";
...
//			System.out.println(userToTest + " would give " + guessStars + " stars to " + movieToTest);
