...
public class DrawingSurface extends PApplet {
	...
	public static final String ratingsFile = "ml-latest-small" + FileIO.DELIMITER + "ratings.csv";
	public static final String moviesFile = "ml-latest-small" + FileIO.DELIMITER + "movies.csv";
	public static final String linksFile = "ml-latest-small" + FileIO.DELIMITER + "links.csv";
	public static final String tagsFile = "ml-latest-small" + FileIO.DELIMITER + "tags.csv";
		...
		new Thread() {
			public void run() {
				predictor = new NetFlixPredictor(moviesFile,ratingsFile,tagsFile,linksFile);
				 ...
				 System.out.println("recommended: " + recommendedID);
				 Movie m = predictor.getMovies().get(predictor.findMovieIndex(recommendedID, predictor.getMovies()));
...
//			ArrayList<Movie> movieData = predictor.getMovies();
			ArrayList<Movie> movieData = predictor.getTopMovies(currentUserID);
			System.out.println(movieData);
			if (movieData.size() < 1) movieData = predictor.getMovies();
