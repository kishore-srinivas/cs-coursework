...
public class CryptTester {
	...
	public static final String FILE_NAME = "RomeoSamples" + System.getProperty("file.separator") + "Romeo.txt";
//	public static final String FILE_NAME = "ShakespeareSamples" + System.getProperty("file.separator") + "ShakespeareWhole.txt";
